        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" action="javascript:void(0);" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="new_user_email" class="form-label">User Email </label>
                        <input type="email" class="form-control" id="new_user_email" name="user_email" required>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" action="javascript:void(0);" method="PUT">
                    ...
                    <div class="mb-3">
                        <label for="updated_user_email" class="form-label">User Email </label>
                        <input type="email" class="form-control" id="updated_user_email" name="user_email" required>
                    </div>
                    <!-- <div class="mb-3">
